"""
Carga de datos históricos OHLC para el backtester.

Pensado para el CSV que exporta TradingView desde el gráfico (ícono de
"Export chart data" / clic derecho → "Export chart data as CSV"). Ese
export trae columnas tipo: time,open,high,low,close[,Volume,...]. También
acepta variantes con Date/Datetime y mayúsculas/minúsculas mezcladas.
"""
